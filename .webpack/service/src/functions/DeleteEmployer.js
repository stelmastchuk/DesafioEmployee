...
/***/ "./src/UseCases/DeleteEmployerUseCase.ts":
/*!***********************************************!*\
  !*** ./src/UseCases/DeleteEmployerUseCase.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"DeleteEmployerUseCase\": () => (/* binding */ DeleteEmployerUseCase)\n/* harmony export */ });\nclass DeleteEmployerUseCase {\r\n    constructor(employeeRepository) {\r\n        this.employeeRepository = employeeRepository;\r\n    }\r\n    async execute(id) {\r\n        const idAlredyExists = await this.employeeRepository.findById(id);\r\n        console.log(idAlredyExists);\r\n        if (!idAlredyExists) {\r\n            return true;\r\n        }\r\n        await this.employeeRepository.delete(id);\r\n    }\r\n}\r\n\r\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/UseCases/DeleteEmployerUseCase.ts\n");
...
/***/ "./src/functions/DeleteEmployer.ts":
/*!*****************************************!*\
  !*** ./src/functions/DeleteEmployer.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"handle\": () => (/* binding */ handle)\n/* harmony export */ });\n/* harmony import */ var _repositories_Repository_EmployeeRepository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @repositories/Repository/EmployeeRepository */ \"./src/repositories/Repository/EmployeeRepository.ts\");\n/* harmony import */ var src_UseCases_DeleteEmployerUseCase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/UseCases/DeleteEmployerUseCase */ \"./src/UseCases/DeleteEmployerUseCase.ts\");\n\r\n\r\nconst handle = async (event) => {\r\n    const { id } = event.pathParameters;\r\n    const employeeRepository = new _repositories_Repository_EmployeeRepository__WEBPACK_IMPORTED_MODULE_0__.EmployeeRepository();\r\n    const deleteEmployerUseCase = new src_UseCases_DeleteEmployerUseCase__WEBPACK_IMPORTED_MODULE_1__.DeleteEmployerUseCase(employeeRepository);\r\n    const res = await deleteEmployerUseCase.execute(id);\r\n    if (res) {\r\n        return {\r\n            statusCode: 400,\r\n            body: JSON.stringify({ message: \"User does not exists!\" }),\r\n            headers: { \"Content-type\": \"application/json\" },\r\n        };\r\n    }\r\n    else {\r\n        return {\r\n            statusCode: 201,\r\n            body: JSON.stringify({ message: \"Delete Sucess!\" }),\r\n            headers: { \"Content-type\": \"application/json\" },\r\n        };\r\n    }\r\n    ;\r\n};\r\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/functions/DeleteEmployer.ts\n");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/functions/DeleteEmployer.ts");
